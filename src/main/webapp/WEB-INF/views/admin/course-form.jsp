...
<head>
    ...
    <c:set var="currentPage" value="courses"/><c:set var="pageTitle" value="Add Course"/>
</head>
<body>
<%@ include file="navbar.jsp" %>
<div class="d-flex align-items-center gap-2 mb-4">
    <a href="/admin/courses" class="btn btn-sm btn-outline-secondary"><i class="bi bi-arrow-left"></i></a>
    <h4 class="fw-bold mb-0"><i class="bi bi-book-half text-warning me-2"></i>Add New Course</h4>
</div>
        ...
        <form method="post" action="/admin/courses/add">
            <div class="row g-3">
                <div class="col-md-8">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="e.g. Object Oriented Programming" required>
                </div>
                <div class="col-md-4">
                    <label class="form-label fw-semibold">Course Code *</label>
                    <input type="text" class="form-control" name="code" placeholder="e.g. SE1020" required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="lecturerId" required>
                        ...
                        <c:forEach items="${lecturers}" var="l">
                            <option value="${l.id}">${l.name} (${l.staffId})</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" name="description" rows="3" placeholder="Brief description of the course" required></textarea>
                </div>
            </div>
            <hr class="my-3">
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-warning text-white"><i class="bi bi-check-lg me-1"></i>Add Course</button>
