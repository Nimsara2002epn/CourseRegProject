...
<div class="dashboard-grid">
    <a href="/admin/users" class="dashboard-tile">
        ...
        <p>Manage system users, roles, login access, and account maintenance.</p>
        <div class="tile-meta">Admin and lecturer accounts</div>
    </a>
    <a href="/admin/lecturers" class="dashboard-tile">
        ...
        <p>Track lecturer profiles, department assignments, and updates.</p>
        <div class="tile-count">${totalLecturers}</div>
    </a>
    <a href="/admin/students" class="dashboard-tile">
        <div class="tile-icon"><i class="bi bi-mortarboard-fill"></i></div>
        <h3>Student Management</h3>
        <p>View student details, registrations, and academic profile records.</p>
        <div class="tile-count">${totalStudents}</div>
    </a>
    <a href="/admin/departments" class="dashboard-tile">
        <div class="tile-icon"><i class="bi bi-building"></i></div>
        <h3>Department Management</h3>
        <p>Control the academic departments and keep their information updated.</p>
        <div class="tile-count">${totalDepartments}</div>
    </a>
    <a href="/admin/courses" class="dashboard-tile">
        <div class="tile-icon"><i class="bi bi-journal-bookmark-fill"></i></div>
        <h3>Course Management</h3>
        <p>Create and organize courses, credits, lecturers, and descriptions.</p>
        <div class="tile-count">${totalCourses}</div>
    </a>
    <a href="/admin/notices" class="dashboard-tile">
        <div class="tile-icon"><i class="bi bi-megaphone-fill"></i></div>
        <h3>Notice Management</h3>
        <p>Publish announcements and keep students informed from one place.</p>
        <div class="tile-count">${recentNotices.size()}</div>
    </a>
</div>
