        ...
        <div class="col-md-5">
            <div class="login-card card">
                <div class="login-header">
                    ...
                    <p class="mb-0 opacity-75">Course Management System</p>
                </div>
                <div class="login-body">
                    ...
                    <div class="mt-3 p-3 bg-light rounded small text-muted">
                        <strong><i class="bi bi-info-circle me-1"></i>Default Admin:</strong><br>
                        Email: <code>admin@university.lk</code><br>
